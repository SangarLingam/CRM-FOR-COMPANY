...
import {
  ...
  CreditCard, UserCircle, LogOut, Home,
  BarChart2, Settings
} from "lucide-react";
...
const NAV = [
  ...
  { label:"Quotes",    href:"/dashboard/quotes",    icon:FileText,        roles:["super_admin","manager","sales","designer"] },
...
const BOTTOM_NAV = [
  { label:"Settings", href:"/dashboard/settings", icon:Settings, roles:["super_admin","manager","sales","designer"] },
];
...
export default function Sidebar() {
  ...
  const bottomItems = BOTTOM_NAV.filter(n => n.roles.includes(user.role));
    ...
    >
      ...
      >
        ...
        <div>
          ...
          <p className="text-slate-500 text-xs mt-0.5">Interior Studio</p>
        </div>
      </div>
